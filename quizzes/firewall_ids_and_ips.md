...
#### Q. Which scenario could cause a stateful firewall to inadvertently block legitimate traffic?

* [x] When the traffic does not correspond to any existing session in the connection state table
...
#### Q. What best describes the function of an IDS within a network?

* [x] A system that observes network traffic for unusual activity and raises alerts
...
#### Q. What is the core distinction between a stateful firewall and a stateless firewall?

* [x] A stateful firewall monitors the state of active connections and uses that context to make filtering decisions
...
#### Q. An IDS flags certain traffic as suspicious, but upon closer review the traffic turns out to be harmless. What is this called?
...
#### Q. How does an IPS differ from antivirus software in terms of where and how it operates?

* [x] An IPS inspects and blocks network traffic in real time, while antivirus software scans and removes malicious files on individual devices
...
#### Q. What type of firewall is best suited for filtering traffic based on specific applications rather than just addresses and ports?

* [x] Application-layer firewall
* [ ] Packet-filtering firewall
* [ ] Stateless firewall
* [ ] Circuit-level gateway

#### Q. What action does an IPS take upon identifying a potential threat in network traffic?

* [x] It notifies the administrator and blocks the suspicious traffic immediately
...
#### Q. What best describes a hybrid IDS/IPS system?

* [x] A system capable of both detecting and preventing threats, depending on its configuration
...
#### Q. What key benefit does a stateful firewall have over a stateless one?

* [x] It can factor in the history of a traffic flow when enforcing security policies, enabling more dynamic rules
...
#### Q. What is the primary role of an IPS when compared with a traditional firewall?

* [x] An IPS can block threats in real time through deep packet inspection, while a firewall mainly filters traffic by IP addresses and ports
...
#### Q. Where in the network should an IDS be placed to achieve the greatest visibility?

* [x] Directly behind the firewall
...
#### Q. What is a potential drawback of configuring an IPS with overly aggressive rules?

* [x] It may mistakenly block legitimate traffic, causing network disruptions
...
#### Q. What is a DMZ (demilitarized zone) in network security?

* [x] A network segment that sits between the internal network and the Internet, hosting public-facing services
...
#### Q. What does deep packet inspection (DPI) allow a firewall or IPS to do?

* [x] Examine the full contents of network packets, including the payload, to identify threats or policy violations
...
#### Q. What distinguishes a network-based IDS (NIDS) from a host-based IDS (HIDS)?

* [x] A NIDS monitors traffic on a network segment, while a HIDS monitors activity on a single host or endpoint
...
* [x] A firewall that combines traditional packet filtering with application awareness, intrusion prevention, and threat intelligence
...
#### Q. How can a zero-day exploit challenge an IDS or IPS deployment?

* [x] Because the attack leverages a previously unknown vulnerability, signature-based detection may fail to recognize it
